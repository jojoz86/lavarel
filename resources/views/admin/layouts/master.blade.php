...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{route('home')}}">
            <img src="{{asset('org/images/front-logo.png')}}" class="navbar-brand-img
          mx-auto" alt="...">
        </a>
            ...
            <ul class="navbar-nav mb-md-3">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="#">
                        <i class="fe fe-git-branch"></i> 系统版本 <span class="badge badge-primary ml-auto">v2.2.2</span>
                    </a>
                </li>
            </ul>
            <!-- User (md) -->
            <div class="navbar-user mt-auto d-none d-md-flex">
                ...
                <div class="dropup">
                    ...
                    <div class="dropdown-menu" aria-labelledby="sidebarIconCopy">
                        <a href="{{route('home')}}" class="dropdown-item">返回首页</a>
                        <a href="{{route('logout')}}" class="dropdown-item">注销登录</a>
                    </div>
                </div>
